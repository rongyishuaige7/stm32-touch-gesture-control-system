...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype.jpg` | 2026-04-02 | EXIF/GPS and other image metadata removed; resized from a copy | Historical touch/gesture prototype photo. |
| `hardware/eda/schematic.pdf` | Export supplied 2026-07-18 | PDF metadata removed from a copy | Historical schematic export; not current-commit hardware evidence. |
