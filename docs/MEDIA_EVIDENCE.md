...
|:--|:--|:--|:--|
| `assets/photos/historical-prototype.jpg` | 2026-04-02 | 已移除 EXIF/GPS 及其他图片元数据；从副本缩放处理 | 历史触摸/隔空手势原型照片。 |
| `hardware/eda/schematic.pdf` | 2026-07-18 提供的导出文件 | 从副本移除 PDF 元数据 | 历史原理图导出；不是当前提交的真机证据。 |
